...
#     parser.add_argument("--feature_dim", type=int, default=207*4, help="number of features") #7
...
#     #cluster
#     parser.add_argument("--c_hidden_dim", type=int, default=16, help="cluster hidden dim")
#     parser.add_argument("--z_dim", type=int, default=4, help="z dim")
#     parser.add_argument("--num_clusters", type=int, default=4, help="num clusters")
#     parser.add_argument("--ST_channels", type=int, default=4, help="channels")
...
def get_args() -> argparse.Namespace:
    ...
    parser.add_argument("--input_len", type=int, default=96, help="input sequence length")
    parser.add_argument("--pred_len", type=int, default=96, help="predicted sequence length")
    parser.add_argument("--feature_dim", type=int, default=207*4, help="number of features")
    ...
    parser.add_argument("--patch_size", type=int, default=4, help="patch size")
    #here ,新加一行
    parser.add_argument("--sep_margin", type=float, default=1.0, help="prototype separation margin")
    ...
    parser.add_argument("--batch_size", type=int, default=32, help="training batch size for clustering")
    parser.add_argument("--cluster_tau", type=float, default=0.5, help="temperature τ for Sinkhorn clustering")

    # optimization
    #here，修改训练or测试模型
    parser.add_argument("--train_flag", type=int, help="training or not", default=0)
